<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="card">
            ...
            <div class="col-md-2">
                <div class="btn-group">
                    <a href="{{ route("sayfaStoreShow") }}" class="btn btn-info waves-effect waves-light w-lg m-b-5">+ Yeni Ekle</a>
                </div>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center text-sm">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li>
                                                <form action="{{ route('sayfaEditShow', ['id' => $page->id]) }}" method="GET">
                                                    @method('GET')
                                                    @csrf
                                            ...
                                            <li>
                                                <form action="{{ route('sayfaDelete', ['id' => $page->id]) }}" method="POST">
                                                    @method('DELETE')
                                                    @csrf
