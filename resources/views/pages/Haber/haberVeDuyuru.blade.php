<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Haber ve Duyuru"></x-navbars.navs.auth>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-xs">{{ $news->baslik }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-xs">{{ $news->urlAdres }}</h6>
                                                </div>
                                            </div>
                                        </td>

                                        <td class="align-middle text-center text-sm">
                                            <span class="badge badge-sm badge-success">{{ $news->created_at }}</span>
                                        </td>
                                        <td class="align-middle">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <li>
                                                        <form action="{{ route('haberDelete', ['id' => $news->id]) }}"
                                                            method="POST">
                                                            @method('DELETE')
                                                            @csrf
