                        ...
                        <div class="col-md-10" style=" margin-left: px;">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form action="{{ route("kategoriStore") }}" method="POST" style="margin-left: 40%" enctype="multipart/form-data">
                                        @csrf

                                        <div class="form-group input-group input-group-outline my-5">
                                            <label for="baslik" class="col-sm-3 control-label">Başlık</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="baslik" name="kBaslik" value="{{ old('kbaslik', $kategori->kBaslik) }}" placeholder="">

                                            </div>
                                        </div>

                                        <div class="form-group input-group input-group-outline my-5">
                                            <label for="baslik" class="col-sm-3 control-label">sira</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="sira" name="sira" value="{{ old('sira', $kategori->sira) }}" placeholder="">
                                        ...
                                        <div class="form-group input-group input-group-outline my-5">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <img src="{{ $kategori->listGorsel }}" id="resim_src" width="150" />
                                                @endif
                                        ...
                                        <div class="form-group input-group input-group-outline my-5">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <img src="{{ $kategori->arkaGorsel }}" id="resim2_src" width="150" />
                                                @endif
                                                <p style="margin-left:10px;font-size:13px;margin-top:5px;">
                                        ...
                                        <div class="form-group input-group input-group-outline my-5">
                                            ...
                                            <div class="col-sm-11">
                                                <textarea class="summernote form-control" rows="9" id="aciklama" name="aciklama">{{ old('icerik', $kategori->aciklama) }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group input-group input-group-outline my-5">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $kategori->title) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group input-group input-group-outline my-5">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="keywords" name="keywords" value="{{ old('keywords', $kategori->keywords) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group input-group input-group-outline my-5">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" rows="5" id="description" name="description">{{ old('description', $kategori->description) }}</textarea>
                                            </div>
                                        </div>
