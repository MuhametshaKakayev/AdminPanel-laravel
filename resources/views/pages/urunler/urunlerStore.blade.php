<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Kategori Ekle"></x-navbars.navs.auth>
        <div class="content-page">
            ...
            <div class="content" style="background-color: rgb(6, 6, 6)">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="pull-left page-title">Urunler ekle</h4>
                        ...
                        <div class="col-md-10" style=" margin-left: px;">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form action="{{ route("urunlerStore") }}" method="POST" style="margin-left: 40%" enctype="multipart/form-data">
                                        @csrf

                                        <div class="form-group input-group input-group-outline my-5">
                                            <label for="baslik" class="col-sm-3 control-label">Başlık</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="baslik" name="baslik" value="{{ old('baslik', $urunler->baslik) }}" placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="radio" name="oneCikan" value="evet" {!! $urunler->oneCikan === 'evet' ? 'checked' : '' !!}> Açık
                                                <input type="radio" name="oneCikan" value="hayir" {!! $urunler->oneCikan === 'hayir' ? 'checked' : '' !!}> Kapalı
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group input-group input-group-outline my-5">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <img src="{{ $urunler->listGorsel }}" id="resim_src" width="150" />
                                                @endif
                                        ...
                                        <div class="form-group input-group input-group-outline my-5">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <img src="{{ $urunler->arkaGorsel }}" id="resim2_src" width="150" />
                                                @endif
                                                <p style="margin-left:10px;font-size:13px;margin-top:5px;">
                                        ...
                                        <div class="form-group input-group input-group-outline my-5">
                                            ...
                                            <div class="col-sm-11">
                                                <textarea class="summernote form-control" rows="9" id="icerik" name="icerik">{{ old('icerik', $urunler->icerik) }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group input-group input-group-outline my-5">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $urunler->title) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group input-group input-group-outline my-5">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="keywords" name="keywords" value="{{ old('keywords', $urunler->keywords) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group input-group input-group-outline my-5">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" rows="5" id="description" name="description">{{ old('description', $urunler->description) }}</textarea>
                                            </div>
                                        </div>
