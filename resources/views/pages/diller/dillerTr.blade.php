                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <form role="form" class="form-horizontal" id="forms" method="POST"
                                    action="ajax.php?p=dil_duzenle&id=1" onsubmit="return false;"
                                    ...
                                    <div class="form-group input-group input-group-outline my-5">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="adi" name="adi"
                                                value="Türkçe" placeholder="Dilin tam adını yazın.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group input-group input-group-outline my-5">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="gosterim_adi"
                                                name="gosterim_adi" value="Türkçe"
...
MS5={Mesaj Gönderilemedi, SMTP Ayarlarınızı Kontrol Ediniz.}</textarea>
                                    ...
                                    <div align="left">
                                        <button type="button" class="btn btn-danger ">Dili Kaldır</button>
                                    </div>

                                    <div align="right">
                                        <button type="submit" class="btn btn-purple ">Kaydet</button>
                                    </div>
