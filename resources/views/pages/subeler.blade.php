<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <x-navbars.sidebar activePage="subeler"></x-navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Subeler"></x-navbars.navs.auth>
        ...
        <div class="card">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="btn-group">
                        <button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5">+ Yeni
                            Ekle</button>
                    </div>
                </div>
                    ...
                    <thead>
                        <tr>
                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                ID</th>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Lokasyon
                            </th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="d-flex px-2 py-1">
                                    <div class="d-flex flex-column justify-content-center">
                                        {{-- <h6 class="mb-0 text-xs">{{ $page->Sıra }}</h6> --}}
                                    </div>
                                </div>
                            </td>
