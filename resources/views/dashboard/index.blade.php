    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            ...
            <div>
                ...
                <div class="col-md-8">
                    <div class="panel panel-default panel-fit">
                        <div class="panel-heading">
                            <h3 class="panel-title">YÖNETİM PANELİNİZE HOŞ GELDİNİZ.</h3>
                        </div>
                        <div class="panel-body">
                            <p>Web sitenizin tüm modifikasyonlarına kolaylıkla müdahale edebileceğiniz özel yönetim ve
                                kontrol panelinizde, sayfanın sol bölümünde bulunan ilgili başlıklar size yardımcı
                                olacaktır.
                                <br /><br />
                                Aldığınız hizmet ile ilgili herhangi bir konuda teknik destek ve bilgi almak için,
                                lütfen bizimle irtibat sağlayınız.
                                <br /><br />
                                Sizleri de ailemizde görmekten büyük bir onur ve kıvanç duyduğumuzu hatırlatır,
                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            <div
                                ...
                                <i class="material-icons opacity-10">weekend
